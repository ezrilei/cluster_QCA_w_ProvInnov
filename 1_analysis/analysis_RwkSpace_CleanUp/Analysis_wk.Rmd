...
# 定义参数组合（±0.10范围内扰动）
params <- list(
  list(name = "Baseline",    incl = 0.75, pri = 0.60),
  list(name = "HighHigh",    incl = 0.85, pri = 0.70),
  list(name = "LowLow",      incl = 0.65, pri = 0.50),
  list(name = "InclUp",      incl = 0.85, pri = 0.60),
  list(name = "InclDown",    incl = 0.65, pri = 0.60),
  list(name = "PRIUp",       incl = 0.75, pri = 0.70),
  list(name = "PRIDown",     incl = 0.75, pri = 0.50),
  list(name = "InclUpPRIDown", incl = 0.85, pri = 0.50),
  list(name = "InclDownPRIUp", incl = 0.65, pri = 0.70)
)
